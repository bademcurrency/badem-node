...
{
	badem::signature_checker checker (0);
	badem::signature_check_set check = { 0, nullptr, nullptr, nullptr, nullptr, nullptr };
...
{
	badem::signature_checker checker (4);
	...
	auto signature_checker_work_func = [&checker]() {
		...
		badem::state_block invalid_block (key.pub, 0, key.pub, 0, 0, key.prv, key.pub, 0);
		...
		std::vector<badem::signature_check_set> signature_checker_sets;
