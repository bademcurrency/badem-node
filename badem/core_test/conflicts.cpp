...
TEST (conflicts, dependency)
{
	...
	badem::genesis genesis;
	badem::keypair key1;
	auto send1 (std::make_shared<badem::send_block> (genesis.hash (), key1.pub, badem::genesis_amount - badem::RAW_ratio, badem::test_genesis_key.prv, badem::test_genesis_key.pub, 0));
	node1->work_generate_blocking (*send1);
	auto state_open1 (std::make_shared<badem::state_block> (key1.pub, 0, badem::test_genesis_key.pub, badem::RAW_ratio, send1->hash (), key1.prv, key1.pub, 0));
...
TEST (conflicts, adjusted_difficulty)
{
	...
	badem::keypair key3;
	ASSERT_EQ (0, node1.active.size ());
	auto send1 (std::make_shared<badem::send_block> (genesis.hash (), key1.pub, badem::genesis_amount - 2 * badem::RAW_ratio, badem::test_genesis_key.prv, badem::test_genesis_key.pub, system.work.generate (genesis.hash ())));
	node1.process_active (send1);
	auto send2 (std::make_shared<badem::send_block> (send1->hash (), badem::test_genesis_key.pub, badem::genesis_amount - 3 * badem::RAW_ratio, badem::test_genesis_key.prv, badem::test_genesis_key.pub, system.work.generate (send1->hash ())));
	...
	auto send3 (std::make_shared<badem::state_block> (key1.pub, open1->hash (), key1.pub, badem::RAW_ratio, key2.pub, key1.prv, key1.pub, system.work.generate (open1->hash ())));
	...
	ASSERT_EQ (node1.ledger.epoch_signer, badem::test_genesis_key.pub);
	auto open_epoch1 (std::make_shared<badem::state_block> (key2.pub, 0, 0, 0, node1.ledger.epoch_link, badem::test_genesis_key.prv, badem::test_genesis_key.pub, system.work.generate (key2.pub)));
	node1.process_active (open_epoch1);
	auto receive2 (std::make_shared<badem::state_block> (key2.pub, open_epoch1->hash (), 0, badem::RAW_ratio, send3->hash (), key2.prv, key2.pub, system.work.generate (open_epoch1->hash ())));
	node1.process_active (receive2);
	auto open2 (std::make_shared<badem::state_block> (key3.pub, 0, key3.pub, badem::RAW_ratio, send4->hash (), key3.prv, key3.pub, system.work.generate (key3.pub)));
	node1.process_active (open2);
	auto change1 (std::make_shared<badem::state_block> (key3.pub, open2->hash (), badem::test_genesis_key.pub, badem::RAW_ratio, 0, key3.prv, key3.pub, system.work.generate (open2->hash ())));
	...
	badem::keypair key4;
	auto open_epoch2 (std::make_shared<badem::state_block> (key4.pub, 0, 0, 0, node1.ledger.epoch_link, badem::test_genesis_key.prv, badem::test_genesis_key.pub, system.work.generate (key4.pub, adjusted_difficulties.find (send1->hash ())->second)));
	uint64_t difficulty;
