...
extern badem::uint256_union const & badem_test_account;
extern badem::uint256_union const & genesis_account;
extern badem::uint256_union const & burn_account;
...
namespace util
{
	...
	public:
		...
		{
			badem::timer<UNIT> timer (badem::timer_state::started);
			bool error = true;
