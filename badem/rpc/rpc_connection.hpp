...
{
public:
	rpc_connection (badem::rpc_config const & rpc_config, boost::asio::io_context & io_ctx, badem::logger_mt & logger, badem::rpc_handler_interface & rpc_handler_interface_a);
	virtual ~rpc_connection () = default;
	virtual void parse_connection ();
	virtual void write_completion_handler (std::shared_ptr<badem::rpc_connection> rpc_connection);
