...
{
public:
	rpc_connection_secure (badem::rpc_config const & rpc_config, boost::asio::io_context & io_ctx, badem::logger_mt & logger, badem::rpc_handler_interface & rpc_handler_interface_a, boost::asio::ssl::context & ssl_context);
	void parse_connection () override;
	void write_completion_handler (std::shared_ptr<badem::rpc_connection> rpc) override;
