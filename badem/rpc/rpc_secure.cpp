...
badem::rpc_secure::rpc_secure (boost::asio::io_service & service_a, badem::rpc_config const & config_a, badem::rpc_handler_interface & rpc_handler_interface_a) :
...
{
	auto connection (std::make_shared<badem::rpc_connection_secure> (config, io_ctx, logger, rpc_handler_interface, this->ssl_context));
