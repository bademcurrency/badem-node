...
namespace ipc
{
	...
	public:
		...
		void async_write (badem::shared_const_buffer const & buffer_a, std::function<void(badem::error, size_t)> callback_a);
	 ...
	 */
	badem::shared_const_buffer prepare_request (badem::ipc::payload_encoding encoding_a, std::string const & payload_a);
}
}
