...
badem::error badem::diagnostics_config::serialize_toml (badem::tomlconfig & toml) const
{
	badem::tomlconfig txn_tracking_l;
...
badem::error badem::diagnostics_config::deserialize_toml (badem::tomlconfig & toml)
{
