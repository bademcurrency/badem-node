...
{
public:
	rollback_visitor (badem::transaction const & transaction_a, badem::ledger & ledger_a, std::vector<std::shared_ptr<badem::block>> & list_a) :
...
bool badem::ledger::rollback (badem::transaction const & transaction_a, badem::block_hash const & block_a, std::vector<std::shared_ptr<badem::block>> & list_a)
{
...
bool badem::ledger::rollback (badem::transaction const & transaction_a, badem::block_hash const & block_a)
{
