...
boost::filesystem::path badem::working_path (bool legacy)
{
	static badem::network_constants network_constants;
	auto result (badem::app_path ());
...
bool badem::migrate_working_path (std::string & error_string)
{
	bool result (true);
	auto old_path (badem::working_path (true));
	auto new_path (badem::working_path ());
...
boost::filesystem::path badem::unique_path ()
{
...
void badem::remove_temporary_directories ()
{
