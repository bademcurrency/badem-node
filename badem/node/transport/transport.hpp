...
namespace transport
{
	...
	public:
		...
		virtual void send_buffer (std::shared_ptr<std::vector<uint8_t>>, badem::stat::detail, std::function<void(boost::system::error_code const &, size_t)> const & = nullptr) = 0;
		virtual std::function<void(boost::system::error_code const &, size_t)> callback (std::shared_ptr<std::vector<uint8_t>>, badem::stat::detail, std::function<void(boost::system::error_code const &, size_t)> const & = nullptr) const = 0;
	...
	private:
		...
		std::atomic<unsigned> network_version{ badem::protocol_version };
