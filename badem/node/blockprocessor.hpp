...
public:
	...
	bool have_blocks ();
	void process_blocks ();
	badem::process_return process_one (badem::transaction const &, badem::unchecked_info, const bool = false);
	badem::process_return process_one (badem::transaction const &, std::shared_ptr<badem::block>, const bool = false);
